/**
 * Digital Node Nexus - Device Firmware Template
 * ============================================
 ...
 *
 * Payload format: Protocol Buffers (nanopb) binary â€” NOT JSON.
 * Schema:  proto/digital_node_nexus.proto
 * Generated headers: digital_node_nexus.pb.h / digital_node_nexus.pb.c  (in this src/ dir)
 *
 ...
 *   LED      â†’ GPIO 2  (built-in LED, or NeoPixel data pin)
 *   Haptic   â†’ GPIO 4  (motor driver IN pin, e.g. DRV2605 or simple transistor)
 *   Display  â†’ I2C SDA/SCL (optional OLED via Adafruit SSD1306)
 */
...
#include <pb_decode.h>
#include <pb_encode.h>
#include "digital_node_nexus.pb.h"
...
// â”€â”€ PIN DEFINITIONS â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
// â”€â”€ MQTT TOPIC TEMPLATES â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
// â”€â”€ WIFI SETUP â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
void connectWiFi() {
...
// â”€â”€ MQTT CALLBACK â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
void onMqttMessage(char* topic, byte* payload, unsigned int length) {
  String topicStr(topic);
  Serial.printf("[MQTT] â† %s (%u bytes binary)\n", topic, length);
  ...
  if (topicStr.endsWith("/cmd/message")) {
    ...
    // Generic/raw command â€” decode RawCmd wrapper, pass payload_json to handler
...
void handleMessage(const MessageCmd& cmd) {
  ...
  // â”€â”€ YOUR DISPLAY CODE HERE â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
void handleLED(const LedCmd& cmd) {
  ...
  // â”€â”€ NEOPIXEL EXAMPLE (uncomment + add Adafruit_NeoPixel library) â”€â”€â”€â”€â”€
 ...
 * Proto: RawCmd { payload_json } â€” payload_json is an arbitrary JSON string.
 ...
 * which decodes as a StatusMsg with all defaults (online=false) â€” signalling
...
// â”€â”€ MQTT CONNECT â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
void connectMQTT() {
...
void setup() {
  Serial.begin(115200);
  delay(100);
  Serial.printf("\n\nDigital Node Nexus Firmware v%s\n", FIRMWARE_VERSION);
